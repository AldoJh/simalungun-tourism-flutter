...
class HotelReviewModel extends Equatable{
    final int? response;
    final bool? success;
    ...
    factory HotelReviewModel.fromJson(Map<String, dynamic> json) => HotelReviewModel(
    ...
    HotelReviewEntity toEntity() => HotelReviewEntity(
        response: response,
        success: success,
        message: message,
