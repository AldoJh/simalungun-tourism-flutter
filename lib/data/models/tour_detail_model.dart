...
class TourDetailModel extends Equatable {
    final num? response;
    final bool? success;
    ...
    factory TourDetailModel.fromJson(Map<String, dynamic> json) => TourDetailModel(
    ...
    TourDetailEntity toEntity() => TourDetailEntity(
        response: response,
        success: success,
        message: message,
        data: data?.toEntity(),
...
class Data extends Equatable {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        facilities: json["facilities"] == null ? [] : List<Category>.from(json["facilities"]!.map((x) => Category.fromJson(x))),
    ...
    DataEntity toEntity() => DataEntity(
      ...
      @override
      // TODO: implement props
      List<Object?> get props => [id, slug, name, phone, rating, category, image, metaDescription, description, location, images, facilities, isRecomended, share, createdAt, updatedAt];
}
